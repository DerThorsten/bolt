...
// On MSVC and GCC < 13, those methods need to be public to be accessible by friend functions.
     ...
     *
     * These methods should be private and the derived iterator should declare bolt::iterator_access
    ...
    class functor_index_iterator : public iterator_base<
        ...
        const std::invoke_result_t<FUNCTOR, std::size_t>,  // Element
        std::random_access_iterator_tag,
        const std::invoke_result_t<FUNCTOR, std::size_t> & // Reference
    >
    {
      public:
        friend class iterator_access;
